...
public class Main {
    ...
    private static void menuFuncionario(Scanner sc, ArrayList<Pedido> pedidos, ArrayList<Evento> eventos){
        ...
        while(op!=0){
            ...
            if(op==1){
                ...
                Persistencia.salvar(pedidos,eventos);
            } else if(op==2){
    ...
    private static void menuPatrao(Scanner sc, ArrayList<Pedido> pedidos, ArrayList<Evento> eventos){
        ...
        while(op!=0){
            ...
            System.out.println("6-Mostrar modelo JSON para ChatGPT");
            System.out.println("7-Importar dados fictícios via JSON");
            System.out.println("0-Voltar");
            System.out.print("Escolha: ");
            op=sc.nextInt();
            ...
            if(op==1){
                ...
                Persistencia.imprimirModelo();
            } else if(op==7){
                Persistencia.importarViaEntrada(sc, pedidos, eventos);
            } else if(op==0){
                System.out.println("Retornando...");
            } else {
                System.out.println("Opção inválida.");
    ...
    public static void main(String[] args){
        ...
        Persistencia.carregar(pedidos, eventos);
        ...
        while(op!=0){
            ...
            System.out.println("3-Mostrar modelo JSON para dados fictícios");
